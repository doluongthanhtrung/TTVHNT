      ...
      <div class="container-fluid">
                ...
                ?>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="form-row" >
                            ...
                            <div class="value">
                                <input class="input--style-6" type="text" name="txt_masv" value="<?php echo $item['MSSV'];?>" disabled> 
                            </div>
                        </div>
                        <div class="form-row" >
                            ...
                            <div class="value">
                              <select class="input-group" name='txt_CLB'>
                                <?php
                                  ...
                                  {
                                    if($clb['MaCLB']==$item['MaCLB']){
                                      echo "<option value='".$clb['MaCLB']."' selected>".$clb['TenCLB']."</option>";
                                    } else {
                        ...
                        <button class="btn btn--radius-2 btn--blue-2" type="submit" name="btn-submit">Cập nhật sinh viên</button>
                        </div> 
                    </form>
        <?php
            }
        ...
        if(isset($_POST['btn-submit'])){
            ...
            if($hoten==''){
                ...
                // Lưu CSDL
                $db=new db();
                $sql="UPDATE sinhvien SET HoTen = '".$hoten."', SDT = '".$sdt."', MaCLB = '".$clb."' WHERE MSSV = '".$mssv."' ";
                $result=$db->query_execute($sql);
                if($result){
                    echo "<script>alert('Cập nhật sinh viên thành công');</script>";
                    echo "<script> window.location = 'index.php'; </script>";
                } else{
                    echo "<script>alert('Lỗi cập nhật sinh viên');</script>";
                }
            }
        }
        ?>
